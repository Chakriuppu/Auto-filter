...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('❤️‍🔥 Add Me To Your Groups or channel ❤️‍🔥', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
            ],[
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/telugumoviesupdates5"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/LazyDeveloper')
            ],[
             InlineKeyboardButton('🙆🏻 Help 🦾', callback_data='help'),
            InlineKeyboardButton('♥️ About ♥️', callback_data='about')
        ],[
             InlineKeyboardButton('HOW TO OPEN LINKS ', url='https://t.me/watch098/12')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('JOIN', url='https://t.me/telugu_macha')],[InlineKeyboardButton('💫HOW TO OPEN💫', url='https://t.me/watch098/12')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
